...
However, shipping the library with all locales will have a size impact on your binary. It also requires you to update your binary whenever CLDR data changes, which happens twice a year. To learn how to solve these problems, see our [data management](/2_2/tutorials/data-management) tutorial.
...
Next, learn how to [generate optimized data for your binary](/2_2/tutorials/data-management), [configure your Cargo.toml file](https://github.com/unicode-org/icu4x/tree/release%2F2.2/tutorials/../examples/cargo), or continue exploring by reading [the docs](https://docs.rs/icu/2.2/).
