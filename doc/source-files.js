...
sourcesIndex["zerovec"] = {"name":"","dirs":[{"name":"map","files":["kv.rs","mod.rs","serde.rs","vecs.rs"]},{"name":"ule","dirs":[{"name":"custom","files":["encode.rs","mod.rs"]}],"files":["chars.rs","error.rs","mod.rs","plain.rs","string.rs","vec.rs"]},{"name":"varzerovec","files":["components.rs","mod.rs","owned.rs","serde.rs","ule.rs"]},{"name":"zerovec","files":["mod.rs","serde.rs"]}],"files":["lib.rs","yoke_impls.rs"]};
createSourceSidebar();
