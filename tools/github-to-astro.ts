...
function printHelp() {
  ...
  console.log();
  console.log("Usage:");
  console.log("\tnpm run icu4x-convert -- --icu4xDir=<input-dir> --icu4xVersion=<minor version> [--icu4xRef=<ICU4X-git-ref>] [--dartVersion=<dart-version>] [--sitePrefix=<site-prefix-str-else-emptystr>] [--overwrite] [--outputScriptPath=<path>]");
  console.log();
  console.log("Options:");
  console.log("\t--dartVersion=<dart-version>\tDart version for pub.dev documentation link (default: <icu4xVersion>.0)");
  console.log();
  console.log("Example: npm run icu4x-convert -- --icu4xDir=../path/to/icu4x/ --icu4xVersion=2.1 [--icu4xRef=release/2.1-draft] [--dartVersion=2.1.0] [--sitePrefix=/uriPrefix] [--overwrite] [--outputScriptPath=build-artifacts.sh]");
}
