...
Using ICU4X in C++ is best demonstrated via the [examples](https://github.com/unicode-org/icu4x/tree/release%2F1.5/tutorials/cpp). For example, [here's an example showing off decimal formatting in ICU4X](https://github.com/unicode-org/icu4x/tree/release%2F1.5/tutorials/cpp/fixeddecimal.cpp), built with [this Makefile](https://github.com/unicode-org/icu4x/tree/release%2F1.5/tutorials/cpp/Makefile).
