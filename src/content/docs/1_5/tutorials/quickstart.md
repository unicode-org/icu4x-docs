...
Next, learn how to [generate optimized data for your binary](/1_5/tutorials/data-management), [configure your Cargo.toml file](/1_5/tutorials/cargo), or continue exploring by reading [the docs](https://docs.rs/icu/1.5/).
