...
sourcesIndex["icu_datetime"] = {"name":"","dirs":[{"name":"fields","files":["length.rs","mod.rs","symbols.rs"]},{"name":"options","files":["components.rs","mod.rs","preferences.rs","style.rs"]},{"name":"pattern","files":["error.rs","mod.rs","parser.rs"]},{"name":"provider","files":["helpers.rs","mod.rs"]}],"files":["arithmetic.rs","date.rs","error.rs","format.rs","lib.rs","mock.rs","skeleton.rs"]};
