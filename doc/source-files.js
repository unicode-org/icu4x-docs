...
sourcesIndex["icu_datetime"] = {"name":"","dirs":[{"name":"fields","files":["length.rs","mod.rs","symbols.rs"]},{"name":"options","files":["components.rs","mod.rs","preferences.rs","style.rs"]},{"name":"pattern","files":["error.rs","mod.rs","parser.rs"]},{"name":"provider","files":["helpers.rs","mod.rs"]}],"files":["date.rs","error.rs","format.rs","lib.rs"]};
...
sourcesIndex["icu_plurals"] = {"name":"","dirs":[{"name":"rules","files":["ast.rs","lexer.rs","mod.rs","parser.rs","resolver.rs","serializer.rs"]}],"files":["data.rs","error.rs","lib.rs","operands.rs","provider.rs"]};
sourcesIndex["icu_provider"] = {"name":"","files":["data_provider.rs","erased.rs","error.rs","hello_world.rs","inv.rs","iter.rs","lib.rs","resource.rs","struct_provider.rs"]};
