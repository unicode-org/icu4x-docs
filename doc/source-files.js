...
sourcesIndex["icu_calendar"] = {"name":"","files":["arithmetic.rs","buddhist.rs","calendar.rs","calendar_arithmetic.rs","coptic.rs","date.rs","datetime.rs","duration.rs","error.rs","ethiopic.rs","gregorian.rs","indian.rs","iso.rs","japanese.rs","julian.rs","lib.rs","provider.rs","types.rs"]};
...
sourcesIndex["icu_datagen"] = {"name":"","dirs":[{"name":"cldr","dirs":[{"name":"cldr_serde","dirs":[{"name":"time_zones","files":["bcp47_tzid.rs","meta_zones.rs","mod.rs","time_zone_names.rs"]}],"files":["aliases.rs","ca.rs","japanese.rs","likely_subtags.rs","list_patterns.rs","mod.rs","numbering_systems.rs","numbers.rs","plurals.rs","week_data.rs"]},{"name":"transform","dirs":[{"name":"calendar","files":["japanese.rs","mod.rs"]},{"name":"datetime","files":["mod.rs","patterns.rs","skeletons.rs","symbols.rs","week_data.rs"]},{"name":"decimal","files":["decimal_pattern.rs","mod.rs"]},{"name":"list","files":["mod.rs"]},{"name":"locale_canonicalizer","files":["aliases.rs","likely_subtags.rs","mod.rs"]},{"name":"plurals","files":["mod.rs"]},{"name":"time_zones","files":["convert.rs","mod.rs"]}],"files":["mod.rs"]}],"files":["cldr_paths.rs","mod.rs","reader.rs"]},{"name":"segmenter","files":["mod.rs","transform.rs"]},{"name":"uprops","files":["bin_uniset.rs","casemapping.rs","enum_codepointtrie.rs","enum_uniset.rs","mod.rs","reader.rs","script.rs","uprops_helpers.rs","uprops_serde.rs"]}],"files":["error.rs","lib.rs"]};
