...
sourcesIndex["icu_provider_cldr"] = {"name":"","dirs":[{"name":"download","files":["cldr_allinone.rs","error.rs","io_util.rs","mod.rs"]},{"name":"transform","dirs":[{"name":"numbers","files":["cldr_serde.rs","decimal_pattern.rs","mod.rs"]},{"name":"time_zones","dirs":[{"name":"cldr_json","files":["convert.rs","mod.rs"]}],"files":["mod.rs"]}],"files":["aliases.rs","dates.rs","likelysubtags.rs","mod.rs","plurals.rs"]}],"files":["cldr_langid.rs","cldr_paths.rs","error.rs","lib.rs","reader.rs","support.rs"]};
...
sourcesIndex["icu_provider_static"] = {"name":"","files":["lib.rs"]};
