...
sourcesIndex["icu_capi"] = {"name":"","files":["custom_writeable.rs","decimal.rs","fixed_decimal.rs","lib.rs","locale.rs","locale_canonicalizer.rs","macros.rs","pluralrules.rs","provider.rs"]};
sourcesIndex["icu_datagen"] = {"name":"","files":["main.rs"]};
sourcesIndex["icu_datetime"] = {"name":"","dirs":[{"name":"fields","files":["length.rs","mod.rs","symbols.rs"]},{"name":"format","files":["datetime.rs","mod.rs","time_zone.rs","zoned_datetime.rs"]},{"name":"mock","files":["datetime.rs","mod.rs","time_zone.rs","zoned_datetime.rs"]},{"name":"options","files":["components.rs","length.rs","mod.rs","preferences.rs"]},{"name":"pattern","files":["error.rs","mod.rs","parser.rs"]},{"name":"provider","files":["gregory.rs","helpers.rs","mod.rs","time_zones.rs"]}],"files":["arithmetic.rs","date.rs","datetime.rs","error.rs","lib.rs","skeleton.rs","time_zone.rs","zoned_datetime.rs"]};
...
sourcesIndex["icu_provider"] = {"name":"","dirs":[{"name":"filter","files":["impls.rs","mod.rs"]},{"name":"marker","files":["impls.rs","macros.rs","mod.rs"]}],"files":["data_provider.rs","dynutil.rs","erased.rs","error.rs","export.rs","hello_world.rs","inv.rs","iter.rs","lib.rs","resource.rs","serde.rs","struct_provider.rs"]};
sourcesIndex["icu_provider_blob"] = {"name":"","dirs":[{"name":"export","files":["blob_exporter.rs","mod.rs"]}],"files":["blob_schema.rs","lib.rs","path_util.rs","static_data_provider.rs"]};
