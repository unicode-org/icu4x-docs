...
However, shipping the library with all locales will have a size impact on your binary. It also requires you to update your binary whenever CLDR data changes, which happens twice a year. To learn how to solve these problems, see our [data management](/icu4x-docs/1_5/tutorials/data_management) tutorial.
...
Next, learn how to [generate optimized data for your binary](/icu4x-docs/1_5/tutorials/data_management), [configure your Cargo.toml file](/icu4x-docs/1_5/tutorials/rust), or continue exploring by reading [the docs](https://docs.rs/icu/latest/).
