...
sourcesIndex["icu_calendar"] = {"name":"","files":["calendar.rs","date.rs","duration.rs","error.rs","iso.rs","lib.rs","types.rs"]};
...
sourcesIndex["icu_datetime"] = {"name":"","dirs":[{"name":"fields","files":["length.rs","macros.rs","mod.rs","symbols.rs"]},{"name":"format","files":["datetime.rs","mod.rs","time_zone.rs","zoned_datetime.rs"]},{"name":"mock","files":["datetime.rs","mod.rs","time_zone.rs","zoned_datetime.rs"]},{"name":"options","files":["components.rs","length.rs","mod.rs","preferences.rs"]},{"name":"pattern","files":["error.rs","generic.rs","mod.rs","parser.rs","transform_hour_cycle.rs"]},{"name":"provider","files":["gregory.rs","helpers.rs","mod.rs","time_zones.rs"]}],"files":["arithmetic.rs","date.rs","datetime.rs","error.rs","lib.rs","skeleton.rs","time_zone.rs","zoned_datetime.rs"]};
