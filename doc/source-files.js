...
sourcesIndex["icu_datetime"] = {"name":"","dirs":[{"name":"fields","files":["length.rs","mod.rs","symbols.rs"]},{"name":"options","files":["components.rs","length.rs","mod.rs","preferences.rs"]},{"name":"pattern","files":["error.rs","mod.rs","parser.rs"]},{"name":"provider","files":["gregory.rs","helpers.rs","mod.rs","timezones.rs"]}],"files":["arithmetic.rs","date.rs","error.rs","format.rs","lib.rs","mock.rs","skeleton.rs"]};
