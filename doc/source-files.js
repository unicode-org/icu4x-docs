...
sourcesIndex["icu4x_verify_zero_copy"] = {"name":"","files":["verify-zero-copy.rs"]};
...
sourcesIndex["icu_calendar"] = {"name":"","files":["arithmetic.rs","buddhist.rs","calendar.rs","calendar_arithmetic.rs","coptic.rs","date.rs","datetime.rs","duration.rs","error.rs","gregorian.rs","iso.rs","japanese.rs","julian.rs","lib.rs","provider.rs","types.rs"]};
...
sourcesIndex["icu_datagen"] = {"name":"","dirs":[{"name":"cldr","dirs":[{"name":"cldr_serde","files":["aliases.rs","ca.rs","japanese.rs","likely_subtags.rs","list_patterns.rs","mod.rs","numbering_systems.rs","numbers.rs","plurals.rs","time_zone_names.rs","week_data.rs"]},{"name":"download","files":["cldr_allinone.rs","error.rs","io_util.rs","mod.rs"]},{"name":"transform","dirs":[{"name":"calendar","files":["japanese.rs","mod.rs"]},{"name":"datetime","files":["mod.rs","patterns.rs","skeletons.rs","symbols.rs","week_data.rs"]},{"name":"decimal","files":["decimal_pattern.rs","mod.rs"]},{"name":"list","files":["mod.rs"]},{"name":"locale_canonicalizer","files":["aliases.rs","likely_subtags.rs","mod.rs"]},{"name":"plurals","files":["mod.rs"]},{"name":"time_zones","files":["convert.rs","mod.rs"]}],"files":["mod.rs"]}],"files":["cldr_paths.rs","error.rs","mod.rs","reader.rs"]},{"name":"segmenter","files":["mod.rs","transform.rs"]},{"name":"uprops","files":["bin_uniset.rs","casemapping.rs","enum_codepointtrie.rs","enum_uniset.rs","mod.rs","reader.rs","script.rs","uprops_helpers.rs","uprops_serde.rs"]}],"files":["lib.rs"]};
...
sourcesIndex["icu_properties"] = {"name":"","files":["error.rs","lib.rs","maps.rs","props.rs","provider.rs","script.rs","sets.rs","trievalue.rs"]};
sourcesIndex["icu_provider"] = {"name":"","dirs":[{"name":"datagen","files":["data_conversion.rs","heap_measure.rs","iter.rs","mod.rs"]},{"name":"marker","files":["impls.rs","mod.rs"]},{"name":"serde","files":["borrow_de_utils.rs","de.rs","mod.rs","ser.rs"]}],"files":["any.rs","buf.rs","data_provider.rs","dynutil.rs","error.rs","export.rs","hello_world.rs","helpers.rs","inv.rs","lib.rs","resource.rs"]};
